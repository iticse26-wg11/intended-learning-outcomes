...
**Area:** Computer Science (CS) · **Sub-area:** Trust, Risk, Verification · **Topic:** Explainability and interpretability of GenAI output
...
---
Stable link: `https://github.com/iticse26-wg11/intended-learning-outcomes/blob/main/ilos/CS04a.md` · Generated from [`ilos.yaml`](../ilos.yaml) by `scripts/build-pages.py`; edit the YAML, not this file.
